...
//		 FIXME Somehow hook this into the loadpath stuff?		
	...
	public static String getDirectoryOfRubyDebuggerFile() {
		RubyCore.copyToStateLocation(LaunchingPlugin.getDefault(), new Path("ruby").append("classic-debug-verbose.rb"));
		RubyCore.copyToStateLocation(LaunchingPlugin.getDefault(), new Path("ruby").append("classic-debug.rb"));
		RubyCore.copyToStateLocation(LaunchingPlugin.getDefault(), new Path("ruby").append("context.rb"));
		File debugFile = RubyCore.copyToStateLocation(LaunchingPlugin.getDefault(), new Path("ruby").append("xml_printer.rb"));
