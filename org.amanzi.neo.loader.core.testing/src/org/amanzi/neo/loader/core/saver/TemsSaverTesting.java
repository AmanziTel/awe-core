...
public class TemsSaverTesting extends AbstractAWETest {
    ...
    static {
        ...
        collectedElement.put(NetworkService.NAME, "Aug 6 12:13:14.15");
        ...
        collectedElement.put(AbstractService.TYPE, DriveNodeTypes.M.getId());
        msCollected1.put(MW, 15.848932266235352d);
        msCollected1.put(DBM, 12.0f);
        msCollected1.put(CODE, 32);
        msCollected1.put(AbstractService.TYPE, DriveNodeTypes.MS.getId());
        msCollected1.put(AbstractService.NAME, "32");
        ...
        msCollected2.put(AbstractService.TYPE, DriveNodeTypes.MS.getId());
        msCollected2.put(AbstractService.NAME, "31");
    ...
    public void testSavingAllElement() {
        ...
        createdMainElement.put(AbstractService.TYPE, DriveNodeTypes.M.getId());
