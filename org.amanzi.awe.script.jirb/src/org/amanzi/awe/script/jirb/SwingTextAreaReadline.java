...
public class SwingTextAreaReadline implements KeyListener {
    ...
    public SwingTextAreaReadline(JTextComponent area) {
        this(area, null);
    }
    
    public SwingTextAreaReadline(JTextComponent area, final String message) {
        this.area = area;
