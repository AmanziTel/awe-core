...
public class NeoTuningPreferencePage extends AbstractPreferencePage {
    ...
    protected void createFieldEditors() {
        ...
        IntegerFieldEditor relationships = new IntegerFieldEditor(Preferences.NEOSTORE_RELATIONSHIPS, LABEL_RELATIONSHIPS,
                getFieldEditorParent());
        relationships.setValidRange(1, Integer.MAX_VALUE);
        addField(relationships, PROPTERTY_NOTE);
        IntegerFieldEditor properties = new IntegerFieldEditor(Preferences.NEOSTORE_PROPERTIES, LABEL_PROPERTIES,
                getFieldEditorParent());
        properties.setValidRange(1, Integer.MAX_VALUE);
        addField(properties, PROPTERTY_NOTE);
        IntegerFieldEditor properties_ind = new IntegerFieldEditor(Preferences.NEOSTORE_PROPERTIES_INDEX,
        ...
        IntegerFieldEditor properties_keys = new IntegerFieldEditor(Preferences.NEOSTORE_PROPERTIES_KEYS, LABEL_PROPERTIES_KEYS,
                getFieldEditorParent());
        properties_keys.setValidRange(1, Integer.MAX_VALUE);
        addField(properties_keys, PROPTERTY_NOTE);
        IntegerFieldEditor properties_string = new IntegerFieldEditor(Preferences.NEOSTORE_PROPERTIES_STRING,
        ...
        IntegerFieldEditor properties_arrays = new IntegerFieldEditor(Preferences.NEOSTORE_PROPERTIES_ARRAYS,
