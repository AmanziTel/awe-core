...
package org.amanzi.awe.ui.icons;
...
public class IconManager {
    ...
    private final Map<IconSize, IconContainer> existedContainers = new HashMap<IconSize, IconContainer>();
    private final List<String> missesIcons = new LinkedList<String>();
    ...
    private String getDirectoryPath(String mainPath, String innerPath) {
        URL fileDir;
        try {
            fileDir = FileLocator.toFileURL(Platform.getBundle(AWEUIPlugin.getDefault().getPluginId())
