...
public class RSpecOutlinePage extends RubyOutlinePage implements
	...
	protected IBaseLabelProvider getLabelProvider() {
		return new LabelProvider() {
			...
			public Image getImage(Object element) {
				...
				if (element instanceof Example) {
					descriptor = RubyElementImageProvider
							.getMethodImageDescriptor(0);
				} else if (element instanceof Behavior) {
					descriptor = RubyElementImageProvider
							.getTypeImageDescriptor(false, false, false);
