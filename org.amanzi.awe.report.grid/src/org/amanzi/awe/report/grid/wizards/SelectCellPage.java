 ...
 * @since 1.0.0
 */
public class SelectCellPage extends SelectNetworkElementsPage {
    ...
    public SelectCellPage() {
        super(SelectCellPage.class.getName(),"Select cell:");
    }
...
//
//        propertyListViewer = new PropertyListViewer(container, "Select cell");
//        propertyListViewer.setInput(new String[] {"5 2 5 1 2 4 6104", "5 2 5 1 2 2 2880", "5 2 5 1 2 2 2870", "5 2 5 1 2 4 6043",
//                "5 2 5 1 2 2 4302"});
...
//        // cmbCategories.setItems(new String[]{"all cells","selected cell","top 10 cells", "top 20
//        // cells","top 30 cells"});
