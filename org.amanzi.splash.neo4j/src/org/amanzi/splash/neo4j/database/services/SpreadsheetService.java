...
public class SpreadsheetService {
	...
	public void updateCellWithReferences(SpreadsheetNode sheet, Cell cell) {
		// if Cell has no Script and have empty Value and Definition than delete
		// it
		...
		try {
			List<String> rfdCellsIDs = NeoSplashUtil
					.findComplexCellIDs((String) cell.getDefinition());
