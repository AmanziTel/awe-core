...
public class PercentageDistributionChartDataset implements IDistributionChartDatasetDelegate {
    ...
    public PercentageDistributionChartDataset() {
        rowKeys.add("Values");
    }
    ...
    public void setDistributionBars(final List<IDistributionBar> distributionBars) {
        ...
        if (distributionBars != null) {
            for (final IDistributionBar distributionBar : distributionBars) {
                totalCount += distributionBar.getCount();
            }
        }
    }
