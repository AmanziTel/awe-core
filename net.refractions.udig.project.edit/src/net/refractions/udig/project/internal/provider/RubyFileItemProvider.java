...
/**
 * This is the item provider adapter for a {@link net.refractions.udig.project.internal.RubyFile} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RubyFileItemProvider extends ItemProviderAdapter implements
	...
	public String getText(Object object) {
		RubyFile rubyFile = ((RubyFile) object);
		String label = rubyFile.getName();
        if( label == null ){
        	Resource resource = rubyFile.eResource();
        	if( resource !=null ){
        ...
        return label == null || label.length() == 0 ? "Unable to load RubyFile" : label;
	}
