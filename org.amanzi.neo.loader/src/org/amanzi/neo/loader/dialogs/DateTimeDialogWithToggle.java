...
public class DateTimeDialogWithToggle extends MessageDialogWithToggle {
     ...
     *  
     */
    public DateTimeDialogWithToggle(Shell parentShell, String dialogTitle, Image image, String message, int dialogImageType,
            String[] dialogButtonLabels, int defaultIndex, String toggleMessage, boolean toggleState, int selDay, int selMonth,
            int selYear) {
