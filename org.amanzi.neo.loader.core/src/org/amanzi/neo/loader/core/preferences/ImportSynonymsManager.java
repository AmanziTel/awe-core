...
public class ImportSynonymsManager {
    ...
    private static final String COUNTERS_SEPARATOR = "\\/";
    private static final String COUNTERS_FLAG = "counters";
    ...
    public static class Synonym {
         ...
         * @param name
         */
        public Synonym(String name, PossibleTypes type, boolean counters) {
            super();
            this.type = type;
            this.name = name;
        ...
        public Synonym(String name) {
            this(name, PossibleTypes.AUTO, false);
        }
    ...
    private void initializeSynonym(String key, String synonyms, boolean updatePreferenceStore) {
        ...
        String[] keyData = key.split(COUNTERS_SEPARATOR);
        boolean counters = false;

        if (keyData.length > 1) {
            if (keyData[1].equals(COUNTERS_FLAG)) {
                counters = true;
            }
        }

        String[] keyParts = keyData[0].split(KEY_PART_SEPARATOR);
        ...
        Synonym synonym = new Synonym(propertyName, dataType, counters);
