...
public abstract class AbstractSaver<T1 extends IDataModel, T2 extends IData, T3 extends IConfiguration>
     ...
     * @param synonym
     */
    protected void addDatasetSynonyms(T1 model, String nodeType, String propertyName, String synonym) {
    ...
    @Override
    public boolean save(T2 dataElement) throws AWEException {
        try {
            saveElement(dataElement);
            commitTx();
            return true;
        } catch (DatabaseException e) {
            ...
            LOGGER.error("Error while saving line ", ex);
            commitTx();
            return true;//TODO: really?
        }
    };

    protected abstract void saveElement(T2 dataElement) throws AWEException;
}
