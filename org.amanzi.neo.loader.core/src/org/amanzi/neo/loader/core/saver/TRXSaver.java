...
public class TRXSaver extends AbstractNetworkSaver {
    ...
    protected void saveLine(List<String> value) throws AWEException {
        if (frequency_rootElement == null) {
            ...
            frequency.put(AbstractService.NAME, parametrizedModel.getName());
            frequency.put(AbstractService.TYPE, NetworkElementNodeType.FREQUENCY_ROOT.getId());
        ...
        if (band.matches(Band.BAND_900.getId())) {
    ...
    private void collectSectorElement(String sectorName) {
        SECTOR_ELEMENT.put(AbstractService.NAME, sectorName);
        SECTOR_ELEMENT.put(AbstractService.TYPE, NetworkElementNodeType.SECTOR.getId());
    ...
    private void collectTRXElement(String subcell, Integer trxId, String band, String extended, boolean isBcch, Integer hoppingType) {
        ...
        TRX_ELEMENT.put(AbstractService.NAME, trxId.toString());
        TRX_ELEMENT.put(AbstractService.TYPE, NetworkElementNodeType.TRX.getId());
    }
