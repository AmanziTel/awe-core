 ...
 */
public class NewSeparationCostraintSaver extends AbstractCSVSaver<NetworkModel> {
    private static Logger LOGGER = Logger.getLogger(TrafficSaver.class);
    private final int MAX_TX_BEFORE_COMMIT = 1000;
    INetworkModel model;

    protected NewSeparationCostraintSaver(INetworkModel model, ConfigurationDataImpl config, GraphDatabaseService service) {
        super(service);
     ...
     * 
     */
    public NewSeparationCostraintSaver() {
        super();
    }
