...
/**
 * This class represents a single collection of geographic objects in the Neo4j database.
 * In other words this class represents something that can be turned into a single layer
 * in the map.
 * @author craig
 * @since 1.0.0
 */
public class NeoGeoResource extends IGeoResource {
    ...
    /**
     * Return a utility object used to read the GIS data. This is used in two places:
     * <ul>
     * <li>the NeoGeoResourceInfo class uses this to determine the envelope for the map</li>
    ...
    public <T> boolean canResolve( Class<T> adaptee ) {
        return adaptee.isAssignableFrom(GeoNeo.class) || super.canResolve(adaptee);
    }
