...
import org.amanzi.awe.views.network.property.NewNewAction;
...
public class NewNetworkPropertySheetPage extends PropertySheetPage implements ISelectionListener {
    ...
    private void createMenu( final Composite parent )
    {
        ...
        deleteAction = new NewDeleteAction(parent, this);
    ...
    private MenuManager createNewSubmenu( final Composite parent )
    {
        ...
        addMenuMgr.add( new NewNewAction( parent, this, PropertyTransform
    ...
    public IDataElement getCurrentNode() {
