 ...
 */
public class NewDeleteAction extends Action    
{
    private NewNetworkPropertySheetPage propertySheet;
    
    private Composite parent;
    
    public NewDeleteAction( final Composite parent,
        final NewNetworkPropertySheetPage propertySheet )
    {
        super("Remove");
    ...
    public void run()
    {
        ...
        Node propertyContainer = ((DataElement)propertySheet.getCurrentNode()).getNode();
    ...
    public void removeProperty( final PropertyContainer container,
            final String key, final NewNetworkPropertySheetPage propertySheet )
    {
