...
public class NewNetworkPropertySource extends NodePropertySource implements IPropertySource {
     ...
     * @param node the node
     */
    public NewNetworkPropertySource(IDataElement node) {
        super(((DataElement)node).getNode(), null);
        isDeltaNode = ((DataElement)node).getNode().getProperty("type","").toString().startsWith("delta_");
    }
