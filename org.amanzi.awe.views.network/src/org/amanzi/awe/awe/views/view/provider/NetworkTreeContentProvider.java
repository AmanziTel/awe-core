 ...
 * @since 1.0.0
 */
public class NetworkTreeContentProvider implements IStructuredContentProvider,
	...
	public boolean hasChildren(Object parentElement) {
		...
		if (parentElement instanceof INetworkModel) {
			...
			try {
				return ((IDistributionModel) parentElement)
						.getDistributionBars().size() > 0;
	...
	public Object[] getElements(Object inputElement) {
		...
		try {
			networkModels = ProjectModel.getCurrentProjectModel()
					.findAllNetworkModels();
		} catch (AWEException e) {
			MessageDialog.openError(null,
					NetworkTreePluginMessages.ERROR_TITLE,
