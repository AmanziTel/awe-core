...
import java.util.regex.Pattern;
    ...
    public  class GPEHFileNameWrapper {
        ...
        private int zStart;
        private int zEnd;
        Pattern time = Pattern.compile("(^A)(\\d{4})(\\d{2})(\\d{2})(\\.)(\\d{2})(\\d{2})([+-]{1}\\d{2})(\\d{2})(-)(\\d{2})(\\d{2})([+-]{1}\\d{2})(\\d{2})(_)(\\w+)(=)(\\w+)(\\,)(\\w+)(=)(\\w+)(\\_)(\\w+)(\\_)(\\w+)(\\_)(\\S+)(\\.)(\\w+)(\\.)(.*$)");
        Pattern time2 = Pattern.compile("(^A)(\\d{4})(\\d{2})(\\d{2})(\\.)(\\d{2})(\\d{2})(-)(\\d{2})(\\d{2})(_)(\\w+)(=)(\\w+)(\\,)(\\w+)(=)(\\w+)(\\_)(\\w+)(\\_)(\\w+)(\\_)(\\S+)(\\.)(\\w+)(\\.)(.*$)");
        private int minEnd;
