...
public enum Parameters {
  ...
  // not in bitpack
    ...
    EVENT_PARAM_HHO_TARGET_ID_1(0),
    EVENT_PARAM_HHO_TARGET_ID_2(0),
    EVENT_PARAM_HHO_TARGET_ID_3(0),
    EVENT_PARAM_HHO_TARGET_ID_4(0),
    EVENT_PARAM_DL_QUALITY_MEAS1_TARGET_CELL(0),
    EVENT_PARAM_DL_QUALITY_MEAS2_TARGET_CELL(0),
    EVENT_PARAM_C_ID_1_SECONDARY_SERV_HSDSCH_CELL(0),
    EVENT_PARAM_PROPAGATION_DELAY(0),
    EVENT_PARAM_SYNCH_INFO_TM_CELL1(0),
    EVENT_PARAM_SYNCH_INFO_TM_CELL2(0),
    EVENT_PARAM_SYNCH_INFO_TM_CELL3(0),
    EVENT_PARAM_SYNCH_INFO_TM_CELL4(0),
    EVENT_PARAM_SCRAMBLING_CODE_NCELL_1(0),
    EVENT_PARAM_SCRAMBLING_CODE_NCELL_2(0),
    EVENT_PARAM_SCRAMBLING_CODE_NCELL_3(0),
    EVENT_PARAM_SCRAMBLING_CODE_NCELL_4(0),
    EVENT_PARAM_SCRAMBLING_CODE_NCELL_5(0),
    EVENT_PARAM_SCRAMBLING_CODE_NCELL_6(0),
    EVENT_PARAM_CPICH_EC_NO_NCELL_1(0),
    EVENT_PARAM_CPICH_EC_NO_NCELL_2(0),
    EVENT_PARAM_CPICH_EC_NO_NCELL_3(0),
    EVENT_PARAM_CPICH_EC_NO_NCELL_4(0),
    EVENT_PARAM_CPICH_EC_NO_NCELL_5(0),
    EVENT_PARAM_CPICH_EC_NO_NCELL_6(0),
    EVENT_PARAM_RSCP_NCELL_1(0),
    EVENT_PARAM_RSCP_NCELL_2(0),
    EVENT_PARAM_RSCP_NCELL_3(0),
    EVENT_PARAM_RSCP_NCELL_4(0),
    EVENT_PARAM_RSCP_NCELL_5(0),
    EVENT_PARAM_RSCP_NCELL_6(0),
    EVENT_PARAM_SYNCH_INFO_TM_NCELL1(0),
    EVENT_PARAM_SYNCH_INFO_TM_NCELL2(0),
    EVENT_PARAM_SYNCH_INFO_TM_NCELL3(0),
    EVENT_PARAM_SYNCH_INFO_TM_NCELL4(0),
    EVENT_PARAM_SYNCH_INFO_TM_NCELL5(0),
    EVENT_PARAM_SYNCH_INFO_TM_NCELL6(0),
    EVENT_PARAM_SOURCE_C_ID_1_SECONDARY_SERV_HSDSCH_CELL(0);
