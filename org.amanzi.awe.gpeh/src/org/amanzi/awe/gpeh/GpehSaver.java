...
public class GpehSaver implements ISaver<GpehTransferData> {
    ...
    public void init(GpehTransferData element) {
        ...
        String datasetName = (String)element.get(GpehTransferData.DATASET);
         tx = DatabaseManager.getInstance().getCurrentDatabaseService().beginTx();
            Node projectNode = datasetService.getProjectNode(projectName, true);
            datasetNode = datasetService.getDatasetNode(projectNode, datasetName, DatasetType.DRIVE, true);
