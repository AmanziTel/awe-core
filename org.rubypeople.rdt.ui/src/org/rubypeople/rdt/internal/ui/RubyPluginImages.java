...
public class RubyPluginImages {
    ...
    private static final String IMG_OBJS_ERB_SCRIPT= NAME_PREFIX + "erb.png";                 //$NON-NLS-1$
    ...
    private static final String IMG_CTOOLS_RUBY_BLOCK = NAME_PREFIX + "block.gif";
    ...
    public static final ImageDescriptor DESC_WIZBAN_RUBY_WORKINGSET= createUnManaged(T_WIZBAN, "ruby_workingset_wiz.png");//$NON-NLS-1$
    ...
    public static final ImageDescriptor DESC_OBJS_BLOCK= createManagedFromKey(T_OBJ, IMG_CTOOLS_RUBY_BLOCK);
