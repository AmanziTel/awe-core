...
public class CellID {
    ...
    private static int getColumnIndexFromCellID(String cellID) {
    ...
    private static int getRowIndexFromCellID(String cellID) {
        String regex = "\\d+";
    ...
    private static String getCellIDfromRowColumn(int row, int column)
    {
