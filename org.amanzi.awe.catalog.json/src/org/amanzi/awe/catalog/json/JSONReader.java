...
public class JSONReader {
	...
	/**
	 * This class provides the API for various anonymous inner classes that
	 * can produce a stream of JSON features. We implement both the Iterator
	 * and the Enumeration interfaces to be friendly to both the java5-style
	 * 'for loop' and the JRuby 'each' method.
