...
public enum GpehReportType {
 ...
 UE_TX_POWER_ANALYSIS("UE_TX_POWER_ANALYSIS"), NBAP_UL_INTERFERENCE("NBAP_UL_INTERFERENCE"),NBAP_DL_TX_CARRIER_POWER("NBAP_DL_TX_CARRIER_POWER"),NBAP_NON_HS_POWER("NBAP_NON_HS_POWER"),NBAP_HSDS_REQUIRED_POWER("NBAP_HSDS_REQUIRED_POWER");
