...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "RRCStatus", isSet = false )
    public class RRCStatus implements IASN1PreparedElement {
            
        @ASN1Element ( name = "protocolErrorInformation", isOptional =  false , hasTag =  false  , hasDefaultValue =  false  )
    
	private ProtocolErrorMoreInformation protocolErrorInformation = null;
       ...
       public static class LaterNonCriticalExtensionsSequenceType implements IASN1PreparedElement {
        ...
        @ASN1Element ( name = "rrcStatus-r3-add-ext", isOptional =  true , hasTag =  false  , hasDefaultValue =  false  )
    
	private BitString rrcStatus_r3_add_ext = null;
	...
	private NonCriticalExtensionsSequenceType nonCriticalExtensions = null;
        ...
        public BitString getRrcStatus_r3_add_ext () {
            return this.rrcStatus_r3_add_ext;
        }

        
        public boolean isRrcStatus_r3_add_extPresent () {
            return this.rrcStatus_r3_add_ext != null;
        }
        

        public void setRrcStatus_r3_add_ext (BitString value) {
            this.rrcStatus_r3_add_ext = value;
        }
	...
	private LaterNonCriticalExtensionsSequenceType laterNonCriticalExtensions = null;
        ...
        public ProtocolErrorMoreInformation getProtocolErrorInformation () {
            return this.protocolErrorInformation;
        }

        

        public void setProtocolErrorInformation (ProtocolErrorMoreInformation value) {
            this.protocolErrorInformation = value;
        }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(RRCStatus.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
