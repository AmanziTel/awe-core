...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "UTRANMobilityInformationFailure", isSet = false )
    public class UTRANMobilityInformationFailure implements IASN1PreparedElement {
	...
	private FailureCauseWithProtErr failureCause = null;
       ...
       public static class LaterNonCriticalExtensionsSequenceType implements IASN1PreparedElement {
        ...
        @ASN1Element ( name = "utranMobilityInformationFailure-r3-add-ext", isOptional =  true , hasTag =  false  , hasDefaultValue =  false  )
    
	private BitString utranMobilityInformationFailure_r3_add_ext = null;
	...
	private NonCriticalExtensionsSequenceType nonCriticalExtensions = null;
        ...
        public BitString getUtranMobilityInformationFailure_r3_add_ext () {
            return this.utranMobilityInformationFailure_r3_add_ext;
        }

        
        public boolean isUtranMobilityInformationFailure_r3_add_extPresent () {
            return this.utranMobilityInformationFailure_r3_add_ext != null;
        }
        

        public void setUtranMobilityInformationFailure_r3_add_ext (BitString value) {
            this.utranMobilityInformationFailure_r3_add_ext = value;
        }
	...
	private LaterNonCriticalExtensionsSequenceType laterNonCriticalExtensions = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(UTRANMobilityInformationFailure.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
