...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "PhysicalChannelReconfigurationComplete", isSet = false )
    public class PhysicalChannelReconfigurationComplete implements IASN1PreparedElement {
	...
	private UL_CounterSynchronisationInfo ul_CounterSynchronisationInfo = null;
       ...
       public static class LaterNonCriticalExtensionsSequenceType implements IASN1PreparedElement {
        ...
        @ASN1Element ( name = "physicalChannelReconfigurationComplete-r3-add-ext", isOptional =  true , hasTag =  false  , hasDefaultValue =  false  )
    
	private BitString physicalChannelReconfigurationComplete_r3_add_ext = null;
	...
	private NonCriticalExtensionsSequenceType nonCriticalExtensions = null;
        ...
        public BitString getPhysicalChannelReconfigurationComplete_r3_add_ext () {
            return this.physicalChannelReconfigurationComplete_r3_add_ext;
        }

        
        public boolean isPhysicalChannelReconfigurationComplete_r3_add_extPresent () {
            return this.physicalChannelReconfigurationComplete_r3_add_ext != null;
        }
        

        public void setPhysicalChannelReconfigurationComplete_r3_add_ext (BitString value) {
            this.physicalChannelReconfigurationComplete_r3_add_ext = value;
        }
	...
	private LaterNonCriticalExtensionsSequenceType laterNonCriticalExtensions = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(PhysicalChannelReconfigurationComplete.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
