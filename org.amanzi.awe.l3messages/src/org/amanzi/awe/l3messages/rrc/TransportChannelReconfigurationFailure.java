...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "TransportChannelReconfigurationFailure", isSet = false )
    public class TransportChannelReconfigurationFailure implements IASN1PreparedElement {
	...
	private FailureCauseWithProtErr failureCause = null;
       ...
       public static class LaterNonCriticalExtensionsSequenceType implements IASN1PreparedElement {
        ...
        @ASN1Element ( name = "transportChannelReconfigurationFailure-r3-add-ext", isOptional =  true , hasTag =  false  , hasDefaultValue =  false  )
    
	private BitString transportChannelReconfigurationFailure_r3_add_ext = null;
	...
	private NonCriticalExtensionsSequenceType nonCriticalExtensions = null;
        ...
        public BitString getTransportChannelReconfigurationFailure_r3_add_ext () {
            return this.transportChannelReconfigurationFailure_r3_add_ext;
        }

        
        public boolean isTransportChannelReconfigurationFailure_r3_add_extPresent () {
            return this.transportChannelReconfigurationFailure_r3_add_ext != null;
        }
        

        public void setTransportChannelReconfigurationFailure_r3_add_ext (BitString value) {
            this.transportChannelReconfigurationFailure_r3_add_ext = value;
        }
	...
	private LaterNonCriticalExtensionsSequenceType laterNonCriticalExtensions = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(TransportChannelReconfigurationFailure.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
