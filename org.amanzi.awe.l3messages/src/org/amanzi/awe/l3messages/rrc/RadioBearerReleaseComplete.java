...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "RadioBearerReleaseComplete", isSet = false )
    public class RadioBearerReleaseComplete implements IASN1PreparedElement {
	...
	private UL_CounterSynchronisationInfo ul_CounterSynchronisationInfo = null;
       ...
       public static class LaterNonCriticalExtensionsSequenceType implements IASN1PreparedElement {
        ...
        @ASN1Element ( name = "radioBearerReleaseComplete-r3-add-ext", isOptional =  true , hasTag =  false  , hasDefaultValue =  false  )
    
	private BitString radioBearerReleaseComplete_r3_add_ext = null;
	...
	private NonCriticalExtensionsSequenceType nonCriticalExtensions = null;
        ...
        public BitString getRadioBearerReleaseComplete_r3_add_ext () {
            return this.radioBearerReleaseComplete_r3_add_ext;
        }

        
        public boolean isRadioBearerReleaseComplete_r3_add_extPresent () {
            return this.radioBearerReleaseComplete_r3_add_ext != null;
        }
        

        public void setRadioBearerReleaseComplete_r3_add_ext (BitString value) {
            this.radioBearerReleaseComplete_r3_add_ext = value;
        }
	...
	private LaterNonCriticalExtensionsSequenceType laterNonCriticalExtensions = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(RadioBearerReleaseComplete.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
