...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "UTRANMobilityInformationConfirm", isSet = false )
    public class UTRANMobilityInformationConfirm implements IASN1PreparedElement {
	...
	private UL_CounterSynchronisationInfo ul_CounterSynchronisationInfo = null;
       ...
       public static class LaterNonCriticalExtensionsSequenceType implements IASN1PreparedElement {
        ...
        @ASN1Element ( name = "utranMobilityInformationConfirm-r3-add-ext", isOptional =  true , hasTag =  false  , hasDefaultValue =  false  )
    
	private BitString utranMobilityInformationConfirm_r3_add_ext = null;
	...
	private NonCriticalExtensionsSequenceType nonCriticalExtensions = null;
        ...
        public BitString getUtranMobilityInformationConfirm_r3_add_ext () {
            return this.utranMobilityInformationConfirm_r3_add_ext;
        }

        
        public boolean isUtranMobilityInformationConfirm_r3_add_extPresent () {
            return this.utranMobilityInformationConfirm_r3_add_ext != null;
        }
        

        public void setUtranMobilityInformationConfirm_r3_add_ext (BitString value) {
            this.utranMobilityInformationConfirm_r3_add_ext = value;
        }
	...
	private LaterNonCriticalExtensionsSequenceType laterNonCriticalExtensions = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(UTRANMobilityInformationConfirm.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
