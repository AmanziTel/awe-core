...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "TransportFormatCombinationControlFailure", isSet = false )
    public class TransportFormatCombinationControlFailure implements IASN1PreparedElement {
	...
	private FailureCauseWithProtErr failureCause = null;
       ...
       public static class LaterNonCriticalExtensionsSequenceType implements IASN1PreparedElement {
        ...
        @ASN1Element ( name = "transportFormatCombinationControlFailure-r3-add-ext", isOptional =  true , hasTag =  false  , hasDefaultValue =  false  )
    
	private BitString transportFormatCombinationControlFailure_r3_add_ext = null;
	...
	private NonCriticalExtensionsSequenceType nonCriticalExtensions = null;
        ...
        public BitString getTransportFormatCombinationControlFailure_r3_add_ext () {
            return this.transportFormatCombinationControlFailure_r3_add_ext;
        }

        
        public boolean isTransportFormatCombinationControlFailure_r3_add_extPresent () {
            return this.transportFormatCombinationControlFailure_r3_add_ext != null;
        }
        

        public void setTransportFormatCombinationControlFailure_r3_add_ext (BitString value) {
            this.transportFormatCombinationControlFailure_r3_add_ext = value;
        }
	...
	private LaterNonCriticalExtensionsSequenceType laterNonCriticalExtensions = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(TransportFormatCombinationControlFailure.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
