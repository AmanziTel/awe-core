...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "RadioBearerSetupComplete", isSet = false )
    public class RadioBearerSetupComplete implements IASN1PreparedElement {
	...
	private UL_CounterSynchronisationInfo ul_CounterSynchronisationInfo = null;
       ...
       public static class LaterNonCriticalExtensionsSequenceType implements IASN1PreparedElement {
        ...
        @ASN1Element ( name = "radioBearerSetupComplete-r3-add-ext", isOptional =  true , hasTag =  false  , hasDefaultValue =  false  )
    
	private BitString radioBearerSetupComplete_r3_add_ext = null;
	...
	private NonCriticalExtensionsSequenceType nonCriticalExtensions = null;
        ...
        public BitString getRadioBearerSetupComplete_r3_add_ext () {
            return this.radioBearerSetupComplete_r3_add_ext;
        }

        
        public boolean isRadioBearerSetupComplete_r3_add_extPresent () {
            return this.radioBearerSetupComplete_r3_add_ext != null;
        }
        

        public void setRadioBearerSetupComplete_r3_add_ext (BitString value) {
            this.radioBearerSetupComplete_r3_add_ext = value;
        }
	...
	private LaterNonCriticalExtensionsSequenceType laterNonCriticalExtensions = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(RadioBearerSetupComplete.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
