...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "PhysicalChannelReconfigurationFailure", isSet = false )
    public class PhysicalChannelReconfigurationFailure implements IASN1PreparedElement {
	...
	private FailureCauseWithProtErr failureCause = null;
       ...
       public static class LaterNonCriticalExtensionsSequenceType implements IASN1PreparedElement {
        ...
        @ASN1Element ( name = "physicalChannelReconfigurationFailure-r3-add-ext", isOptional =  true , hasTag =  false  , hasDefaultValue =  false  )
    
	private BitString physicalChannelReconfigurationFailure_r3_add_ext = null;
	...
	private NonCriticalExtensionsSequenceType nonCriticalExtensions = null;
        ...
        public BitString getPhysicalChannelReconfigurationFailure_r3_add_ext () {
            return this.physicalChannelReconfigurationFailure_r3_add_ext;
        }

        
        public boolean isPhysicalChannelReconfigurationFailure_r3_add_extPresent () {
            return this.physicalChannelReconfigurationFailure_r3_add_ext != null;
        }
        

        public void setPhysicalChannelReconfigurationFailure_r3_add_ext (BitString value) {
            this.physicalChannelReconfigurationFailure_r3_add_ext = value;
        }
	...
	private LaterNonCriticalExtensionsSequenceType laterNonCriticalExtensions = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(PhysicalChannelReconfigurationFailure.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
