...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "ActiveSetUpdateFailure", isSet = false )
    public class ActiveSetUpdateFailure implements IASN1PreparedElement {
	...
	private FailureCauseWithProtErr failureCause = null;
       ...
       public static class LaterNonCriticalExtensionsSequenceType implements IASN1PreparedElement {
        ...
        @ASN1Element ( name = "activeSetUpdateFailure-r3-add-ext", isOptional =  true , hasTag =  false  , hasDefaultValue =  false  )
    
	private BitString activeSetUpdateFailure_r3_add_ext = null;
	...
	private NonCriticalExtensionsSequenceType nonCriticalExtensions = null;
        ...
        public BitString getActiveSetUpdateFailure_r3_add_ext () {
            return this.activeSetUpdateFailure_r3_add_ext;
        }

        
        public boolean isActiveSetUpdateFailure_r3_add_extPresent () {
            return this.activeSetUpdateFailure_r3_add_ext != null;
        }
        

        public void setActiveSetUpdateFailure_r3_add_ext (BitString value) {
            this.activeSetUpdateFailure_r3_add_ext = value;
        }
	...
	private LaterNonCriticalExtensionsSequenceType laterNonCriticalExtensions = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(ActiveSetUpdateFailure.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
