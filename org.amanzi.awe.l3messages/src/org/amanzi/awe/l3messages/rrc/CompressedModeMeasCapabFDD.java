...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "CompressedModeMeasCapabFDD", isSet = false )
    public class CompressedModeMeasCapabFDD implements IASN1PreparedElement {
  ...
  @ASN1Boolean( name = "" )
	...
	private Boolean ul_MeasurementsFDD = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(CompressedModeMeasCapabFDD.class);
