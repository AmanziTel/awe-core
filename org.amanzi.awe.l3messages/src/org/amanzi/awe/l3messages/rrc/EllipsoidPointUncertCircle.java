...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "EllipsoidPointUncertCircle", isSet = false )
    public class EllipsoidPointUncertCircle implements IASN1PreparedElement {
  ...
  @ASN1Integer( name = "" )
    @ASN1ValueRangeConstraint ( 
        ...
        @ASN1Element ( name = "uncertaintyCode", isOptional =  false , hasTag =  false  , hasDefaultValue =  false  )
    
	private Integer uncertaintyCode = null;
        ...
        public Integer getUncertaintyCode () {
            return this.uncertaintyCode;
        }

        

        public void setUncertaintyCode (Integer value) {
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(EllipsoidPointUncertCircle.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
