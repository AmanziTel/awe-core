...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "RadioBearerReconfigurationFailure", isSet = false )
    public class RadioBearerReconfigurationFailure implements IASN1PreparedElement {
	...
	private RB_IdentityList potentiallySuccesfulBearerList = null;
       ...
       public static class LaterNonCriticalExtensionsSequenceType implements IASN1PreparedElement {
        ...
        @ASN1Element ( name = "radioBearerReconfigurationFailure-r3-add-ext", isOptional =  true , hasTag =  false  , hasDefaultValue =  false  )
    
	private BitString radioBearerReconfigurationFailure_r3_add_ext = null;
	...
	private NonCriticalExtensionsSequenceType nonCriticalExtensions = null;
        ...
        public BitString getRadioBearerReconfigurationFailure_r3_add_ext () {
            return this.radioBearerReconfigurationFailure_r3_add_ext;
        }

        
        public boolean isRadioBearerReconfigurationFailure_r3_add_extPresent () {
            return this.radioBearerReconfigurationFailure_r3_add_ext != null;
        }
        

        public void setRadioBearerReconfigurationFailure_r3_add_ext (BitString value) {
            this.radioBearerReconfigurationFailure_r3_add_ext = value;
        }
	...
	private LaterNonCriticalExtensionsSequenceType laterNonCriticalExtensions = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(RadioBearerReconfigurationFailure.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
