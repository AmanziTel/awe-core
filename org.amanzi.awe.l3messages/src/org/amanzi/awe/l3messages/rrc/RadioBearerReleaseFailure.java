...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "RadioBearerReleaseFailure", isSet = false )
    public class RadioBearerReleaseFailure implements IASN1PreparedElement {
	...
	private RB_IdentityList potentiallySuccesfulBearerList = null;
       ...
       public static class LaterNonCriticalExtensionsSequenceType implements IASN1PreparedElement {
        ...
        @ASN1Element ( name = "radioBearerReleaseFailure-r3-add-ext", isOptional =  true , hasTag =  false  , hasDefaultValue =  false  )
    
	private BitString radioBearerReleaseFailure_r3_add_ext = null;
	...
	private NonCriticalExtensionsSequenceType nonCriticalExtensions = null;
        ...
        public BitString getRadioBearerReleaseFailure_r3_add_ext () {
            return this.radioBearerReleaseFailure_r3_add_ext;
        }

        
        public boolean isRadioBearerReleaseFailure_r3_add_extPresent () {
            return this.radioBearerReleaseFailure_r3_add_ext != null;
        }
        

        public void setRadioBearerReleaseFailure_r3_add_ext (BitString value) {
            this.radioBearerReleaseFailure_r3_add_ext = value;
        }
	...
	private LaterNonCriticalExtensionsSequenceType laterNonCriticalExtensions = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(RadioBearerReleaseFailure.class);
        public IASN1PreparedElementData getPreparedData() {
            return preparedData;
        }
