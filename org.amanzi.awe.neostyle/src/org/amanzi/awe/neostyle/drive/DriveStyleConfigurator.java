...
public class DriveStyleConfigurator extends IStyleConfigurator {
	...
	private DriveStyleDefiner defaultStyle = new DriveStyleDefiner();
	 ...
	 */
	private IRenderableModel findRenderableModel() {
		IRenderableModel model;
		try {
			model = getLayer().findGeoResource(IRenderableModel.class).resolve(
