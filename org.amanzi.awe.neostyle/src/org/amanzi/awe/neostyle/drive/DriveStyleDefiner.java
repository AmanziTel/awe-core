...
public class DriveStyleDefiner extends ViewPart {
	 ...
	 *            Drive Style
	 */
	public DriveStyleDefiner(DriveStyle driveStyle) {
	...
	public void setCurrentStyle(DriveStyle driveStyle) {
		this.currentStyle = driveStyle;
	}
	...
	private String[] getMeasurementProperties() {
		if (model != null) {
			return ((DriveModel) model).getAllPropertyNames(DriveNodeTypes.M);
		}
		return new String[0];
	}
	...
	public void setRenderableModel(IRenderableModel model) {
		this.model = model;
	}
}
