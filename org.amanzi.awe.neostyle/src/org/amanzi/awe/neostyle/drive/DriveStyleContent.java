...
public class DriveStyleContent extends StyleContent {
	...
	private static final Color DEFAULT_LOCATION_COLOR = new Color(255, 255, 128);
	 ...
	 * 
	 * @see
	 * net.refractions.udig.project.StyleContent#save(org.eclipse.ui.IMemento,
	 * java.lang.Object)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * net.refractions.udig.project.StyleContent#load(org.eclipse.ui.IMemento)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * net.refractions.udig.project.StyleContent#createDefaultStyle(net.refractions
	 * .udig.catalog.IGeoResource, java.awt.Color,
	 * org.eclipse.core.runtime.IProgressMonitor)
	 */
	@Override
	public DriveStyle createDefaultStyle(IGeoResource resource, Color colour,
