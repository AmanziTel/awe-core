...
public class Messages extends NLS {
	...
	public static String Location_Property;
	public static String Location_color;
	public static String Location_Label;
	public static String Location_Label_Property;
	public static String Location_Label_Font_Size;
