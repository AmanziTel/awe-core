...
public class NetworkNeoStyleContent extends StyleContent {
	...
	public static final String DEF_SECTOR_LABEL_TYPE_ID = NetworkElementNodeType.SECTOR
			.getId();
	...
	private static final String PREFERENCE_DEFAULT_BEAMWIDTH = "BEAMWIDTH";
	...
	public NetworkNeoStyle createDefaultNetworkStyle() {
		NetworkNeoStyle result = new NetworkNeoStyle(DEF_COLOR_LINE,
				DEF_COLOR_FILL, DEF_COLOR_LABEL);
		...
		result.setDefaultBeamwidth(AweUiPlugin.getDefault()
				.getPreferenceStore().getInt(PREFERENCE_DEFAULT_BEAMWIDTH));
	...
	public Object load(IMemento memento) {
		...
		result.setFixSymbolSize(Boolean.parseBoolean(memento
				.getString(FIX_SYMBOL)));
