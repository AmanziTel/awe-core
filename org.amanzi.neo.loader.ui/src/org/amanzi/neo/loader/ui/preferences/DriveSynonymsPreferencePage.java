 ...
 * @since 1.0.0
 */
public class DriveSynonymsPreferencePage extends AbstractDatasetSynonymsPreferencePage {

    /**
     * @param description
     */
    public DriveSynonymsPreferencePage() {
        super(Messages.DriveSynonymsPreferencePage_DriveSynonymsPage_Description);
    }
