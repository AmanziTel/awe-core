...
public class LoaderUiPluginMessages extends NLS {

    private static final String BUNDLE_NAME = LoaderUiPluginMessages.class.getName();
    ...
    private LoaderUiPluginMessages() {
    }
    ...
    static {
        NLS.initializeMessages(BUNDLE_NAME, LoaderUiPluginMessages.class);
    }
