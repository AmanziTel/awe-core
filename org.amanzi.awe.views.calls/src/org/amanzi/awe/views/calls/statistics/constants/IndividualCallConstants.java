...
public class IndividualCallConstants implements ICallStatisticsConstants {
    ...
    public final float INDIV_CALL_DELAY_P2 = 0.15f;
    public final float INDIV_CALL_DELAY_P3 = 0.25f;
    public final float INDIV_CALL_DELAY_P4 = 0.3f;

    public final float INDIV_CALL_DELAY_L1 = 0.35f;
    public final float INDIV_CALL_DELAY_L2 = 0.4f;
    public final float INDIV_CALL_DELAY_L3 = 0.45f;
    public final float INDIV_CALL_DELAY_L4 = 0.55f;
