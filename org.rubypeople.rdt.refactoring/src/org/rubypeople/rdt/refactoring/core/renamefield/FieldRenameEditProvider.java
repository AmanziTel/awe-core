...
public class FieldRenameEditProvider extends ReplaceEditProvider {

	private FieldItem fieldItem;
	private String newName;
	private ISourcePosition position;

	public FieldRenameEditProvider(FieldItem fieldItem, String newName){
		super(false);
	...
	protected int getOffsetLength() {
		return position.getEndOffset() - position.getStartOffset();
	}

	@Override
	protected Node getEditNode(int offset, String document) {
		return fieldItem.getRenamedNode(newName);
	}
