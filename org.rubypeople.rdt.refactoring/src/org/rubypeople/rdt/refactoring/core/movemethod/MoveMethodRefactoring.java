...
public class MoveMethodRefactoring extends RubyRefactoring {
	...
	public MoveMethodRefactoring(IRefactoringContext selectionProvider) {
		super(NAME, selectionProvider);
		
		MoveMethodConfig config = new MoveMethodConfig(new DocumentWithIncluding(getDocumentProvider()), selectionProvider.getCaretPosition());
