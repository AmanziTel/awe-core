package org.amanzi.awe.distribution.engine.internal;
 ...
 */
public class DistributionEnginePlugin extends AbstractProviderPlugin {

    // The plug-in ID
    private static final String PLUGIN_ID = "org.amanzi.awe.distribution.engine"; //$NON-NLS-1$

    private static final String DISTRIBUTION_MODEL_PROVIDER = "org.amanzi.providers.distributionModelProvider";

    // The shared instance
    private static DistributionEnginePlugin plugin;

    /**
     * The constructor
     */
    public DistributionEnginePlugin() {
    }
