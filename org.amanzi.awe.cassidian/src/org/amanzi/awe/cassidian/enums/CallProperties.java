...
public enum CallProperties {
    ...
    MINIMUM_LQ("Minimum listening quality"),
    MAXIMUM_LQ("Maximum listening quality"),
    AVERAGE_LQ("Average listening quality"),
    DELAY("Audio delay"),
    MINIMUM_DELAY("Minimum audio delay"),
    MAXIMUM_DELAY("Maximum audio delay"),
    AVERAGE_DELAY("Average audio delay"),
    ...
    public enum CallType {
        INDIVIDUAL("has_individual_calls"), GROUP("has_group_calls"), SDS("has_sds"), TSM("has_tsm"), ALARM("has_alarm"), EMERGENCY(
                "has_emergency"), HELP("has_help"), ITSI_ATTACH("has_attach"), ITSI_CC("has_itsi_cc"), ITSI_HO("has_itsi_ho"), CS_DATA(
                "has_csd"), PS_DATA("has_psd");
        ...
        /**
         * @return Returns the hasCallsProperty.
         */
