...
import org.amanzi.awe.gpeh.console.parser.Events;
import org.amanzi.awe.gpeh.console.parser.Parameters;
...
public class GpehCSVSaver implements ISaver<GpehTransferData> {
    ...
    public void initOutputDirectory(String outputDir) {
        outputDirectory = outputDir;
        beforeLoading = System.currentTimeMillis();
    }

    @Override
    public void save(GpehTransferData element) throws IOException {
        count++;
        ...
        // read id of event
        GPEHEvent.Event event = (GPEHEvent.Event)element.remove(GpehTransferData.EVENT);
