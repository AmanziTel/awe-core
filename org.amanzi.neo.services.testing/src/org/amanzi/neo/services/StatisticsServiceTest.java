...
public class StatisticsServiceTest extends AbstractNeoServiceTest {
	...
	public void saveVaultPositiveTest() throws DatabaseException,
		...
		PropertyStatistics propStat = new PropertyStatistics("Counter",
				Integer.class);
	...
	public void doubleSaveVaultPositiveTest() throws DatabaseException,
		...
		PropertyStatistics sectorStat = new PropertyStatistics("Sector counter", 
				Integer.class);
		...
		PropertyStatistics neighbourStat = new PropertyStatistics("Neighbours counter",
				Integer.class);
	...
	public void savePropertyStatisticsNullParameterVaultNodeNegativeTest()
			throws DatabaseException, InvalidStatisticsParameterException {
		service.savePropertyStatistics(new PropertyStatistics("name",
				String.class), null);
	}
	...
	public void loadPropertyStatisticsPositiveTest() throws DatabaseException,
		...
		PropertyStatistics actualPropStat = service
