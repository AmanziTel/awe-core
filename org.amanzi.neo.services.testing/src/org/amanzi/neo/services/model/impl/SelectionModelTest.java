...
public class SelectionModelTest extends AbstractNeoServiceTest {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void checkIsExistSelectionLinkElementIsNull() {
        getSelectionModel().isExistSelectionLink(null);
    }

    @SuppressWarnings("unchecked")
    @Test
    public void checkIsExistSelectionLink() throws AWEException {
        Node sectorNode = getSectorNode();
        DataElement element = new DataElement(sectorNode);
        ...
        when(networkService.findSelectionLink(eq(selectionRootNode), eq(sectorNode), any(Index.class))).thenReturn(null);
        assertEquals(false, selectionModel.isExistSelectionLink(element));
        verify(networkService).findSelectionLink(eq(selectionRootNode), eq(sectorNode), any(linkIndexes.getClass()));

    }

    @Test(expected = IllegalArgumentException.class)
    public void checkDeleteSelectionLinkElementIsNull() {
        getSelectionModel().deleteSelectionLink(null);
    }
    ...
    public void checkDeleteSelectionLink() throws AWEException {
        ...
        selectionModel.deleteSelectionLink(element);
        verify(networkService).deleteSelectionLink(eq(selectionRootNode), eq(sectorNode), any(linkIndexes.getClass()));
