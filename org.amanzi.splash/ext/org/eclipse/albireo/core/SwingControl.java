...
public abstract class SwingControl extends Composite {
  ...
  �  * set that approximately matches the window's contents.
     ...
     * see the <a href="http://java.sun.com/j2se/1.4.2/docs/api/java/com.eteks.tools.awt/doc-files/FocusSpec.html">AWT
   ...
   /** 
    ...
    protected boolean handleFocusOperation(final RunnableWithResult focusSetter) {
        ...
        if (swingComponent != null) {
            ...
            // Fail if there is no underlying com.eteks.tools.swing component
            return false;
        }
    }
     ...
     * be notified when the embedded com.eteks.tools.swing control has changed its size
     * preferences. 
     *
