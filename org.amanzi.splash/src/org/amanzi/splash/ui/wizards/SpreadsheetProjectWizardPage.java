...
public class SpreadsheetProjectWizardPage extends RubyProjectWizardFirstPage {
	...
	public SpreadsheetProjectWizardPage(IWorkbench workbench2, String pageName) {
		//super(pageName);
	...
	public void createControl(Composite parent) {
		...
		rowText.addModifyListener(new ModifyListener() {
			public void modifyText(ModifyEvent e) {
				SpreadsheetProjectWizardPage.this.handleEvent(null);
	...
	public boolean finish() {
		IFile newFile =  (IFile) new File(getProjectName() + ".jrss");// createNewFile();
		try {
	...
	private void validateFileName() {
		String filename = getProjectName();//getFileName();
