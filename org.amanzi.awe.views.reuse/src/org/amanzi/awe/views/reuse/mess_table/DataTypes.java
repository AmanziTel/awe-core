...
public enum DataTypes {
	...
	ROMES(DriveTypes.ROMES, NodeTypes.M), NEMO1(DriveTypes.NEMO1, NodeTypes.M), NEMO2(
			DriveTypes.NEMO2, NodeTypes.M), TEMS(DriveTypes.TEMS, NodeTypes.M), MS(
			DriveTypes.MS, NodeTypes.M),

	NETWORK_PLAN(null, NodeTypes.TRX), NETWORK(null, NodeTypes.SECTOR);
	...
	public static DataTypes getTypeByNode(Node aNode) {
		...
		if (key == null) {
			...
			Logger.getLogger(DataTypes.class).error(
					"DriveTypes not found for node " + aNode);
			return null;
		}
