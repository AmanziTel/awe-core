...
//        try {
//            Node gis = getDriveModel().getRootNode();
//            if (gis == null) {
//                return;
//            }
...
//        }
    ...
    private void formPropertyList() {
        ...
        Transaction tx = NeoUtils.beginTransaction();
        try {
            Traverser tr = getDriveModel().getRootNode().traverse(Order.BREADTH_FIRST, NeoUtils.getStopEvaluator(2), new ReturnableEvaluator() {
    ...
    private void setProperty(GeoNeo geo) {
        Node gisNode = getDriveModel().getRootNode();
    ...
    private void updateChart() {
        ...
        if (driveModel == null || event.isEmpty() || getCurrentPropertyCount() < 1) {
            setsVisible(false);
        }
