 ...
 * 
 * <pre><code>
 *  RollbackAction x = new RollbackAction( ... );
 *  TODO code example
 * </code></pre>
 * 
 * </p>
 ...
 * @since 0.3
 */
public class RollbackAction implements IEditorActionDelegate {
    ...
    public void run( IAction action ) {
        try {
            editor.getMap().getEditManagerInternal().rollbackTransaction();
        } catch (IOException e) {
