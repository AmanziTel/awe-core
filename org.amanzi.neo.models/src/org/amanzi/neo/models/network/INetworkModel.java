...
public interface INetworkModel extends IPropertyStatisticalModel, IRenderableModel, IDistributionalModel {
     ...
     */
    public void replaceRelationship(IDataElement newParentElement, IDataElement currentNode) throws ModelException;
     ...
     */
    public ISelectionModel findSelectionModel(String name) throws ModelException;
     ...
     */
    public ISelectionModel createSelectionModel(String name) throws ModelException;
     ...
     */
    public ISelectionModel getSelectionModel(String name) throws ModelException;
     ...
     */
    public Iterable<ISelectionModel> getAllSelectionModels() throws ModelException;
     ...
     * @throws ModelException
     */
    public IDataElement findElement(Map<String, Object> params) throws ModelException;
     ...
     * @throws ModelException
     */
    public IDataElement findSector(String propertyName, String propertyValue) throws ModelException;
     ...
     * @throws ModelException
     */
    public IDataElement createElement(IDataElement parent, Map<String, Object> params) throws ModelException;
     ...
     * @throws ModelException
     */
    public void deleteElement(IDataElement elementToDelete) throws ModelException;
     ...
     * @throws ModelException
     */
    public void renameElement(IDataElement elementToRename, String newName) throws ModelException;
     ...
     * @throws ModelException
     */
    public void updateElement(IDataElement elementToUpdate, String propertyName, Object newValue) throws ModelException;
     ...
     * @throws ModelException
     */
    public IDataElement completeProperties(IDataElement existedElement, Map<String, Object> newPropertySet, boolean isReplaceExisted) throws DatabaseException, ModelException;
     ...
     */
    @Deprecated
    public IDataElement createElement(IDataElement parent, Map<String, Object> element, RelationshipType type) throws ModelException;
     ...
     */
    @Deprecated
    public void createRelationship(IDataElement parent, IDataElement child, RelationshipType rel) throws ModelException;
     ...
     * @throws DatabaseException
     */
    public Set<IDataElement> findElementByPropertyValue(INodeType type, String propertyName, Object propertyValue) throws DatabaseException;
     ...
     * @throws ModelException
     */
    public Iterable<ISelectionModel> getAllSelectionModelsOfSector(IDataElement element) throws ModelException;

    public IDataElement getNetworkElement(IDataElement parent, Map<String, Object> params) throws ModelException;
     ...
     */
    public INodeToNodeRelationsModel getCurrentNodeToNodeRelationshipModel() throws ModelException;
     ...
     * @throws ModelException
     */
    public void setCurrentNodeToNodeRelationshipModel(INodeToNodeRelationsModel model) throws ModelException;
     ...
     * @throws ModelException
     */
    public INetworkModel getStarToolSelectedModel() throws ModelException;
     ...
     * @throws ModelException
     */
    public void setStarToolSelectedModel() throws ModelException;

    /**
     * Removing star tool selected model;
     */
    public void removeStarToolSelectedModel() throws ModelException;
