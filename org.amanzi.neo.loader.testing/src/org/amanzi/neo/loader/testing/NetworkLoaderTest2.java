 ...
 * TODO Purpose of
 * <p>
 * Test2 of NetworkLoader
 * </p>
 * 
 * @author Cinkel_A
 * @since 1.0.0
 */
public class NetworkLoaderTest2 {
    private static final long MAX_LOAD_TIME = 2 * 60 * 1000;
    protected static String filename = "Network_GSM_Germany.csv";
    ...
    public void testLineError() {
        assertEquals(0, networkLoader.lineErrors.size());
    }
