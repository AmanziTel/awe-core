...
/**
 * <p>
 * Tests for Alarm messages statistics.
 * </p>
 * @author Shcharbatsevich_A
 * @since 1.0.0
 */
public class AlarmMessagesStatTest extends AmsStatisticsTest{
    ...
    protected IDataGenerator getDataGenerator(Integer aHours, Integer aDrift, Integer aCallsPerHour, Integer aCallPerHourVariance,
        ...
        return DataGenerateManager.getAlarmMessagesGenerator(dataDir, aHours, aDrift, aCallsPerHour, aCallPerHourVariance, aProbes);
    }
