...
/**
 * <p>
 * Tests for emergency calls statistics.
 * </p>
 * @author Shcharbatsevich_A
 * @since 1.0.0
 */
public class EmergencyCallStatTest extends AmsStatisticsTest{
    ...
    protected IDataGenerator getDataGenerator(Integer aHours, Integer aDrift, Integer aCallsPerHour, Integer aCallPerHourVariance,
        ...
        return DataGenerateManager.getEmergencyGenerator(dataDir, aHours, aDrift, aCallsPerHour, aCallPerHourVariance, aProbes, maxGroupSize);
    }
