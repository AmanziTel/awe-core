...
/**
 * <p>
 * Test for call statistics for SDS messages (xml).
 * </p>
 * @author Shcharbatsevich_A
 * @since 1.0.0
 */
public class SDSMessagesXmlStatTest extends SDSMessagesStatTest{
    ...
    protected IDataGenerator getDataGenerator(Integer aHours, Integer aDrift, Integer aCallsPerHour, Integer aCallPerHourVariance,
        ...
        return DataGenerateManager.getXmlSDSMessagesGenerator(dataDir, aHours, aDrift, aCallsPerHour, aCallPerHourVariance, aProbes);
    }
