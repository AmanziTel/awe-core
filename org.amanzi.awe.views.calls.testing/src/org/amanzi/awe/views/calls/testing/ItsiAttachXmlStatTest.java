...
/**
 * <p>
 * Tests for ITSI Attach statistics (xml).
 * </p>
 * @author Shcharbatsevich_A
 * @since 1.0.0
 */
public class ItsiAttachXmlStatTest extends ItsiAttachStatTest{
    ...
    protected IDataGenerator getDataGenerator(Integer aHours, Integer aDrift, Integer aCallsPerHour, Integer aCallPerHourVariance,
        ...
        return DataGenerateManager.getXmlItsiAttachGenerator(dataDir, aHours, aDrift, aCallsPerHour, aCallPerHourVariance, aProbes);
    }
