 ...
 *   <li>{@link net.refractions.udig.project.internal.impl.SpreadsheetImpl#getChildSpreadsheets <em>Child Spreadsheets</em>}</li>
 *   <li>{@link net.refractions.udig.project.internal.impl.SpreadsheetImpl#getParentSpreadsheet <em>Parent Spreadsheet</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SpreadsheetImpl extends EObjectImpl implements Spreadsheet {
	...
	/**
	 * The cached value of the '{@link #getChildSpreadsheets() <em>Child Spreadsheets</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getChildSpreadsheets()
	 * @generated
	 * @ordered
	 */
	protected List<Spreadsheet> childSpreadsheets;
	...
	public void setRubyProjectInternal(RubyProject newRubyProjectInternal) {
		if (newRubyProjectInternal != rubyProjectInternal) {
			...
			if (newRubyProjectInternal != null)
				msgs = ((InternalEObject) newRubyProjectInternal).eInverseAdd(
						this,
						ProjectPackage.RUBY_PROJECT__RUBY_ELEMENTS_INTERNAL,
						RubyProject.class, msgs);
	...
	public void setSpreadsheetPath(URL newSpreadsheetPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ProjectPackage.SPREADSHEET__SPREADSHEET_PATH,
					oldSpreadsheetPath, spreadsheetPath));
	}
	...
	public void setSpreadsheetType(SpreadsheetType newSpreadsheetType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ProjectPackage.SPREADSHEET__SPREADSHEET_TYPE,
					oldSpreadsheetType, spreadsheetType));
	}
	 ...
	 * @generated
	 */
	public List<Spreadsheet> getChildSpreadsheets() {
		if (childSpreadsheets == null) {
			childSpreadsheets = new EObjectContainmentWithInverseEList(
					Spreadsheet.class, this,
					ProjectPackage.SPREADSHEET__CHILD_SPREADSHEETS,
					ProjectPackage.SPREADSHEET__PARENT_SPREADSHEET);
		}
		return childSpreadsheets;
	}
	...
	public Spreadsheet getParentSpreadsheet() {
		if (eContainerFeatureID() != ProjectPackage.SPREADSHEET__PARENT_SPREADSHEET)
			return null;
		return (Spreadsheet) eContainer();
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetParentSpreadsheet(
			Spreadsheet newParentSpreadsheet, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newParentSpreadsheet,
				ProjectPackage.SPREADSHEET__PARENT_SPREADSHEET, msgs);
		return msgs;
	}
	 ...
	 * @generated
	 */
	public void setParentSpreadsheet(Spreadsheet newParentSpreadsheet) {
		if (newParentSpreadsheet != eInternalContainer()
				|| (eContainerFeatureID() != ProjectPackage.SPREADSHEET__PARENT_SPREADSHEET && newParentSpreadsheet != null)) {
			if (EcoreUtil.isAncestor(this, newParentSpreadsheet))
				throw new IllegalArgumentException(
						"Recursive containment not allowed for " + toString()); //$NON-NLS-1$
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			if (newParentSpreadsheet != null)
				msgs = ((InternalEObject) newParentSpreadsheet).eInverseAdd(
						this, ProjectPackage.SPREADSHEET__CHILD_SPREADSHEETS,
						Spreadsheet.class, msgs);
			msgs = basicSetParentSpreadsheet(newParentSpreadsheet, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ProjectPackage.SPREADSHEET__PARENT_SPREADSHEET,
					newParentSpreadsheet, newParentSpreadsheet));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case ProjectPackage.SPREADSHEET__CHILD_SPREADSHEETS:
			return ((InternalEList) getChildSpreadsheets()).basicAdd(otherEnd,
					msgs);
		case ProjectPackage.SPREADSHEET__PARENT_SPREADSHEET:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			return basicSetParentSpreadsheet((Spreadsheet) otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case ProjectPackage.SPREADSHEET__CHILD_SPREADSHEETS:
			return ((InternalEList) getChildSpreadsheets()).basicRemove(
					otherEnd, msgs);
		case ProjectPackage.SPREADSHEET__PARENT_SPREADSHEET:
			return basicSetParentSpreadsheet(null, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ProjectPackage.SPREADSHEET__CHILD_SPREADSHEETS:
			return getChildSpreadsheets();
		case ProjectPackage.SPREADSHEET__PARENT_SPREADSHEET:
			return getParentSpreadsheet();
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ProjectPackage.SPREADSHEET__SPREADSHEET_TYPE:
			...
			return;
		case ProjectPackage.SPREADSHEET__CHILD_SPREADSHEETS:
			getChildSpreadsheets().clear();
			getChildSpreadsheets().addAll((Collection) newValue);
			return;
		case ProjectPackage.SPREADSHEET__PARENT_SPREADSHEET:
			setParentSpreadsheet((Spreadsheet) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		...
		case ProjectPackage.SPREADSHEET__CHILD_SPREADSHEETS:
			...
			return;
		case ProjectPackage.SPREADSHEET__PARENT_SPREADSHEET:
			setParentSpreadsheet((Spreadsheet) null);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case ProjectPackage.SPREADSHEET__SPREADSHEET_PATH:
			return SPREADSHEET_PATH_EDEFAULT == null ? spreadsheetPath != null
					: !SPREADSHEET_PATH_EDEFAULT.equals(spreadsheetPath);
		case ProjectPackage.SPREADSHEET__SPREADSHEET_TYPE:
			return SPREADSHEET_TYPE_EDEFAULT == null ? spreadsheetType != null
					: !SPREADSHEET_TYPE_EDEFAULT.equals(spreadsheetType);
		case ProjectPackage.SPREADSHEET__CHILD_SPREADSHEETS:
			return childSpreadsheets != null && !childSpreadsheets.isEmpty();
		case ProjectPackage.SPREADSHEET__PARENT_SPREADSHEET:
			return getParentSpreadsheet() != null;
		}
