...
public interface EditManager extends EObject, IEditManager {
    ...
    /**
     * Sets the value of the '{@link net.refractions.udig.project.internal.EditManager#getEditFeature <em>Edit Feature</em>}'
     ...
     * 
     * @param value the new value of the '<em>Edit Feature</em>' attribute.
     * @param layer A layer that the feature is part of.
     * @see #getEditFeature()
     * @model
     */
    void setEditFeature( Feature value, Layer layer ) throws IllegalArgumentException;
     ...
     * @throws IllegalAttributeException
     */
    public void addFeature( Feature feature, Layer layer ) throws IOException,
