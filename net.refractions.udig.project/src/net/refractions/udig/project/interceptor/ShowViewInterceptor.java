 ...
 * @since 1.1.0
 */
public class ShowViewInterceptor implements IResourceInterceptor<FeatureSource> {
    ...
    public FeatureSource run(ILayer layer, FeatureSource resource,
            Class<? super FeatureSource> requestedType) {
        ...
        if (prop instanceof Filter || prop instanceof Query) {
            try {
                ...
                if (parent instanceof IService) {
                    ...
                    FeatureSource view = ds.getView(query);
