...
//		fEnableAssertionsCheckBox.setSelection(false);
	...
	protected List createInactiveStackFiltersList() {
		String[] strings=
			TestUnitPreferencePage.parseList(getPreferenceStore().getString(TestUnitPreferencesConstants.PREF_INACTIVE_FILTERS_LIST));
	...
	public static String[] getFilterPatterns() {
		...
		return TestUnitPreferencePage.parseList(store.getString(TestUnitPreferencesConstants.PREF_ACTIVE_FILTERS_LIST));
	}
